...
** Last Update:		$Author: rickr $, $Date: 2005/06/22 14:39:43 $
** Source File:		$RCSfile: l_mri_dicom_hdr.c,v $
...
#include "Amalloc.h"
#include "dbtrace.h"    /* rcr - instead of debugtrace.h */
...
ENTRY("readFile1") ;
	...
	*scannedLength = 0;
	...
	if (cond != DCM_NORMAL) {
		...
		CTN_FREE(elementItem);     /* 14 June 2005 [rickr] */
		RETURN( cond ) ;
	    }
	}
